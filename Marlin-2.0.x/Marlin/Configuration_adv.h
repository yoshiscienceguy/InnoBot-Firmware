 ...
 *
 * Your board's pins file specifies the recommendedd pins. Override those here
 * or set to -1 to disable completely.
 *
 * Multiple extruders can be assigned to the same pin in which case
 * the fan will turn on when any selected extruder is above the threshold.
 */
#define E0_AUTO_FAN_PIN 8 //fdp
...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 25 //fdp
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define LONG_FILENAME_HOST_SUPPORT //fdp
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_FEEDRATE         5  // (mm/s) Initial retract feedrate.
...
//fdp
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V //fdp
   ...
   */
  #define SENSORLESS_HOMING //fdp // StallGuard capable drivers only 

  #if EITHER(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  2 //fdp
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  2 //fdp
