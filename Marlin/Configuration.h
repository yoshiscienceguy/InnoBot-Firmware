...
#define CUSTOM_MACHINE_NAME "InnoBot"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 400, 1000 }
...
#define XY_PROBE_SPEED  HOMING_FEEDRATE_XY//fdp
...
#define Z_HOMING_HEIGHT 18  // (in mm) Minimal z height before homing (G28) for Z clearance above the bed, clamps, ...
